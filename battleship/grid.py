...
class grid:
    ...
    def redo_move(self):
        try:
            ...
            for shipname, ship_coords in self.shipinfo.items():
                self.placeOnBoard(ship_coords, eval(shipname + ()))
        except:
    ...
    def placeOnBoard(self, ship_coords, ship_obj, print_board=False):
        ...
        if count == ship_obj.getLength():
            ...
            self.shipinfo[ship_obj.getName()] = ship_coords
